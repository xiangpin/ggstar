...
```{r, fig.width=7, fig.height=6, fig.align="center", dpi=300, starshapes}
p1 <- show_starshapes()
p1
```
...
```{r, fig.width=6, fig.height=5, fig.align="center", dpi=300, sizeshape}
library(ggplot2)
library(ggstar)
...
```{r, fig.width=6, fig.height=5.2, fig.align="center", dpi=300, polarcoord}
